...
pub(super) fn fixture_native_input(repo_root: &Path) -> PathBuf {
    repo_root.join(
        "app/gui/workbench/src-tauri/testing/data/.tmp_e2e_output_py/140_orig.native_input.nii.gz",
    )
}

pub(super) fn fixture_python_pred(repo_root: &Path) -> PathBuf {
    repo_root.join(
        "app/gui/workbench/src-tauri/testing/data/.tmp_e2e_output_py/140_orig.python_pred.nii.gz",
    )
}
...
pub(super) fn ensure_native_input_nifti(
    ...
    let fixture_dir = repo_root
        .join("app/gui/workbench/src-tauri/testing/data/.tmp_e2e_output_py");

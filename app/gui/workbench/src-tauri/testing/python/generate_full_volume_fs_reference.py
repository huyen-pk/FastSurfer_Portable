...
def resolve_input_paths(repo_root: Path) -> tuple[Path, Path]:
    ...
    native_input_nii = repo_root / "app/gui/workbench/src-tauri/testing/data/.tmp_e2e_output_py/140_orig.native_input.nii.gz"
...
def run_subject140_one_slice_geometry_generation(repo_root: Path) -> Path:
    ...
    fs_reference_root = repo_root / "app/gui/workbench/src-tauri/testing/data/fs_reference/Subject140"
